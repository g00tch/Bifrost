...
CONFIGFOLDER='/root/.bifrost'
COIN_DAEMON='bifrostd'
COIN_CLI='bifrost-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/bifrost-actual/bifrost-coin/releases/download/v1.0.3/bifrost-1.0.3-aarch64-linux-gnu.tar.gz'
...
function important_information() {
 echo
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${PURPLE}Windows Wallet Guide. https://github.com/g00tch/Bifrost/master/README.md${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 ...
 echo -e "${GREEN}bifrost-cli masternode status${NC}"
 echo -e "${GREEN}bifrost-cli getinfo.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${RED}Donations always excepted gratefully.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${YELLOW}Bifrost: B6q3pMccExvyejrGrB5tRLK12dhmuRBTFC${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
